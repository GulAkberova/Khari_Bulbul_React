...
<form onSubmit={handleSubmit(gonder)}>
                    <h3 data-aos="zoom-in"   data-aos-duration='1200' >Login</h3>
                ...
                <label>
                    ...
                    <input type={"text"} {...register("email",{required:true})} placeholder={"Ad "} data-aos="fade-left"   data-aos-duration='1300' data-aos-delay='50' />
                ...
                <label>
                    ...
                    <br/>
                    <i data-aos-delay='250' data-aos="fade-right"   data-aos-duration='1200' class="fa-solid fa-lock"></i>
                    <input  type={"password"} {...register("sifre",{required:true,maxLength:8})} placeholder={"Sifre"} data-aos-delay='250' data-aos="fade-left"   data-aos-duration='1200' />
                    <br/>
                    {errors.sifre?.type=="required" && <span style={{color:"red",fontSize:"10px",padding:"0px 25px"}}>Zehmet olmasa xanani doldurun</span>}
             ...
             <div>
                ...
                <button  className={regis.button2}><NavLink to={"/register"}>Register</NavLink></button>
                </div>
